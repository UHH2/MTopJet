...
int main(int argc, char* argv[]){
  ...
  // declare files
  TFile *f_tt = new TFile(dir+"uhh2.AnalysisModuleRunner.MC.TTbar_allHad.root");
  ...
  gPad->RedrawAxis();
  c2->SaveAs("/afs/desy.de/user/s/schwarzd/Plots/Resolution_Subjets/AllHadronic/pt_"+mean_median+"_seperateJets.pdf");
  ...
  leg3->Draw();
  gPad->RedrawAxis();
  c3->SaveAs("/afs/desy.de/user/s/schwarzd/Plots/Resolution_Subjets/AllHadronic/nonClosure"+mean_median+".pdf");
